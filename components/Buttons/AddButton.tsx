...
return ()=> document.removeEventListener('click',handleOutClick)    
  ...
  return (
    <div className='relative' ref={optionsElement} > 
               <div className={`border-b-2 p-1 hover:border-primary-buttons ${showOptions && ' border-base'}`}>
                <AddIcon className="w-6 h-6 bg-primary-buttons  rounded-full hover:text-primary-buttons hover:bg-white hover:scale-125 transition-all duration-200 cursor-pointer" onClick={()=>setShowOptions(!showOptions)} />
                    </div>
