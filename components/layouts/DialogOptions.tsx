  ...
  return (
    <div className="flex flex-col justify-center items-end">
      <MoreHorizIcon
        ...
        className={`cursor-pointer ${isActive && "more-options-active"}`}
      />
      <div className="dialog-container relative z-10 hidden ">
        ...
        <div className="bg-primary rounded-sm py-2 ">
          ...
          <div
            ...
            className="text-center text-xs cursor-pointer p-1 hover:bg-secondary-text"
          >
            Eliminar notas{" "}
            <RadioButtonCheckedIcon
              className={` text-primary-buttons transition-all duration-200 ${
                deleteCards ? "opacity-100" : "opacity-0"
              }`}
            />
          </div>
        </div>
